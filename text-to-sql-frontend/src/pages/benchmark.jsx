...
export default function Benchmark() {
  ...
  return (
    <div className={`max-w-3xl mx-auto flex flex-col items-center bg-white p-6 transition-all duration-700 ${pageVisible ? "opacity-100 scale-100" : "opacity-0 scale-95"}`}>
      ...
      <div ref={sections["Error Types"]} className="mt-16">
      ...
      <div ref={sections["Response Times"]} className="mt-16">
      ...
      <div ref={sections["Pricing"]} className="mt-16">
      ...
      <div ref={sections["Conclusion"]} className="mt-16">
