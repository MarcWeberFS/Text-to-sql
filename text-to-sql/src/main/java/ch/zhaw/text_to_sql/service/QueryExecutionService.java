...
public class QueryExecutionService {
    ...
    /**
     * Handles the query execution process, including sending the query to the LLM and executing it against the database.
     * 
     * @param prompt The natural language prompt to be processed.
     * @param userFeedbackLoop Indicates if user feedback should be incorporated in the query generation.
     * @param syntaxFeedbackLoop Indicates if syntax feedback should be incorporated in the query generation.
     * @param allowEmptyResponse Indicates if an empty response is allowed.
     * @param model The model to be used for processing the query (e.g., chatgpt, gemini, claude, deepseek, grok).
     * @return A QueryResponse object containing the executed query, number of retries, whether it improved, and the result set.
     */
